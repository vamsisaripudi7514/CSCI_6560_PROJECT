...
GRANT EXECUTE ON PROCEDURE rbac_system.sp_get_employee_details TO 'system_user'@'localhost';
GRANT EXECUTE ON PROCEDURE rbac_system.sp_update_employee TO 'system_user'@'localhost';
...
GRANT EXECUTE ON PROCEDURE rbac_system.sp_project_mapping_update_list TO 'system_user'@'localhost';
GRANT EXECUTE ON PROCEDURE rbac_system.sp_update_project_mapping TO 'system_user'@'localhost';
GRANT EXECUTE ON PROCEDURE rbac_system.sp_select_audit_logs TO 'system_user'@'localhost';
GRANT EXECUTE ON PROCEDURE rbac_system.sp_get_user_audit_logs TO 'system_user'@'localhost';
