...
sp_insert_employee: BEGIN
    ...
    IF v_is_allowed THEN
        ...
        VALUES (p_employee_id, p_employee_name, p_employee_email, p_employee_phone, p_employee_role_id, p_employee_manager_id, p_employee_salary, p_employee_hire_date);
